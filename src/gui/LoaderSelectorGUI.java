...
public class LoaderSelectorGUI extends JDialog {
	...
	private void dirlist(File[] list) throws Exception{
		...
		table.setModel(modelVersion);
		    for(int i = 0; i < list.length; i++){
		    	hasElements = true;
		    	modelVersion.addRow(new String[]{list[i].getName()});
		    	MyLogger.getLogger().debug("Adding "+list[i].getName()+" to list of loaders");
		    }
	    if (!hasElements) {
